...
public class MailReport {
    ...
    public static String reportHtml() {
        ...
        int allCase = report.getCaseSum();
        int passCase = report.getPassCaseSum();
        int failCase = allCase - passCase;
        String passRate = report.getPassRate();  //通过率
        ...
        String h = "<TABLE Align='center' width=1000px>\n" +
                ...
                "            <td align=\"center\" style=\"background: #eeeee0;white-space: nowrap;\">" + runTime + "</td>\n" +
